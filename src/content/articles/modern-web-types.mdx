...
While I fully support the goal of not shipping code that breaks in some browsers, TypeScript's two-engine policy doesn't fully protect you from that. On the flip side, the absence of official types _does_ mean that folks who choose to use new APIs are far more likely to do so with incomplete or even incorrect types.
