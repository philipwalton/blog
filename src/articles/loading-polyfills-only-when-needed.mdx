...
This topic has come up several times in conversation recently, so I decided to write about my approach. I want to stress that I'm not trying to promote this as the _one true way_ to conditionally load polyfills&mdash;it just happens to be the way I like to do it. It's the best balance of simplicity and performance for my projects.
...
The primary principle of my polyfill strategy is: _I optimize the experience for users on modern browsers._
...
I also want to stress that you should be making this decision based on _your_ usage data, not global percentages.
