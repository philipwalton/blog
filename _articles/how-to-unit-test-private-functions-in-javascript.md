...
<div class="callout">
  ...
  <div>To explain some of my rationale, I wrote a follow-up article:<br><a href="{{linkTo '/articles/why-i-test-private-functions-in-javascript/'}}">Why I Test Private Functions In JavaScript</a></div>
</div>
