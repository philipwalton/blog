...
To see if you can figure it out, click the _edit on Codepen_ link above and play around with it for a bit. If you've succeeded, it should look like the example below.

_Warning: Don't click on the CSS tab of the example below or it will give away the answer._
...
> [!NOTE]
> In addition to opacity, several newer CSS properties also create stacking contexts. These include: [transforms](http://www.w3.org/TR/css3-transforms/), [filters](http://www.w3.org/TR/filter-effects/), [css-regions](http://www.w3.org/TR/css3-regions/), [paged media](http://www.w3.org/TR/css3-page/), and possibly others. As a general rule, it seems that if a CSS property requires rendering in an offscreen context, it must create a new stacking context.
