...
We've also released a [small JavaScript library](https://github.com/GoogleChromeLabs/first-input-delay) so you can measure this metric yourself and better understand _your_ user's first impressions.
